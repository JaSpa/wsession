...
%%% The following is specific to ICFP '23 and the paper
%%% 'Intrinsically Typed Sessions with Callbacks'
%%% by Peter Thiemann.
%%%
\setcopyright{rightsretained}
\acmPrice{}
\acmDOI{10.1145/3607854}
\acmYear{2023}
\copyrightyear{2023}
\acmSubmissionID{icfp23main-p93-p}
\acmJournal{PACMPL}
\acmVolume{7}
\acmNumber{ICFP}
\acmArticle{212}
...
% Java \cite{DBLP:conf/ecoop/HuYH08}.
...
% Some (e.g., \cite{DBLP:journals/jfp/Padovani17}) rely
